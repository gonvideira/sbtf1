...
// The fund's own page. Declared once so the nav, the hero and the "Funds"
// rail card cannot drift from the real route.
const fundPath = '/en/funds/sbtf-1/'

// The fund's title — used as the section label and as the fund page's H1.
const fundTitle = 'The Fund'

// Reused verbatim in three places: the hero subheadline, the fund page
// masthead standfirst and the "Funds" rail teaser blurb.
...
export const en: SiteContent = {
  ...
  nav: {
    ...
    // The homepage is the Hub: the fund anchors now live on the fund page.
    items: [
      { label: 'Hub', anchor: '#hub' },
      { label: 'Resources', anchor: '#recursos' },
      { label: 'Funds', anchor: '#fundos' },
    ],
    cta: { label: 'Invest', anchor: `${fundPath}#investir` },
    investorArea: { label: 'Investor Area', badge: 'Coming soon' },
  },

  hero: {
    // kicker draft — pending ACB/JAP sign-off
    kicker: 'STAG · BLUE ECONOMY',
    ...
    ctaPrimary: { label: 'Discover the Fund', anchor: fundPath },
  ...
  hub: {
    ...
    // The opening sentence of `intro`, not a word changed.
    metaDescription:
      'In a sector where information sits scattered, we want to be the resource that brings it together for anyone operating, investing or researching in the Portuguese or European blue economy.',
    contribution: {
  ...
  funds: [
    {
      ...
      teaser: {
        ...
        // Assembled from `terms.rows`; the ¹ resolves in the card's footnote.
        terms: '€126M target size · 3 verticals · 20% IRR¹ · 2026–2034',
      },
