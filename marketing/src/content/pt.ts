...
// A página do fundo. Declarada uma vez para que a nav, o hero e o cartão do
// rail "Fundos" não possam divergir da rota real.
const fundPath = '/pt/fundos/sbtf-1/'

// Título do fundo — usado como rótulo de secção e como H1 da página do fundo.
const fundTitle = 'O Fundo'

// Reutilizada literalmente em três sítios: o subtítulo do hero, o standfirst do
// masthead da página do fundo e o blurb do cartão no rail "Fundos".
const fundSubheadline =
...
export const pt: SiteContent = {
  ...
  nav: {
    ...
    // A homepage é o Hub: as âncoras do fundo vivem agora na página do fundo.
    items: [
      { label: 'Hub', anchor: '#hub' },
      { label: 'Recursos', anchor: '#recursos' },
      { label: 'Fundos', anchor: '#fundos' },
    ],
    cta: { label: 'Investir', anchor: `${fundPath}#investir` },
    investorArea: { label: 'Área do Investidor', badge: 'Brevemente' },
  },

  hero: {
    // kicker draft — pending ACB/JAP sign-off
    kicker: 'STAG · ECONOMIA AZUL',
    headlineLine1: 'Crescer com o Mar',
    headlineLine2: 'dar escala à economia azul.',
    subheadline: fundSubheadline,
    ctaPrimary: { label: 'Conhecer o Fundo', anchor: fundPath },
  ...
  hub: {
    ...
    // A primeira frase de `intro`, sem uma palavra alterada.
    metaDescription:
      'Num sector com informação dispersa, queremos ser um recurso que centraliza informação relevante para quem opera, investe ou investiga na economia azul portuguesa ou europeia.',
    contribution: {
  ...
  funds: [
    {
      slug: 'sbtf-1',
      path: fundPath,
      pageTitle: 'SBTF 1 · Blue Transformation Fund',
      metaDescription:
      ...
      teaser: {
        number: 'Fundo #1',
        name: 'STAG Blue Transformation Fund 1',
        blurb: fundSubheadline,
        // Montado a partir de `terms.rows`; o ¹ resolve na nota de rodapé do cartão.
        terms: '€126M dimensão-alvo · 3 verticais · 20% IRR¹ · 2026–2034',
      },
      sectionLabel: fundTitle,
      title: fundTitle,
      subnav: [
