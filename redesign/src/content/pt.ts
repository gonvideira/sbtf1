...
export const pt: SiteContent = {
  ...
  nav: {
    ...
    metaDescription:
      'Fundo de private equity de €126M focado na economia azul portuguesa: aquacultura sustentável, transformação de seafood e BlueTech. Gerido pela STAG Fund Management, regulada pela CMVM.',
    items: [
  ...
  hero: {
    ...
    headlineLine1: 'Portugal não precisa de provar que sabe trabalhar o mar.',
    headlineLine2: 'Precisa de escalar o que já faz bem.',
    subheadline:
