...
export const en: SiteContent = {
  ...
  nav: {
    ...
    metaDescription:
      "A €126M private equity fund investing across Portugal's blue economy: sustainable aquaculture, seafood processing and BlueTech. Managed by STAG Fund Management, regulated by the CMVM.",
    items: [
  ...
  hero: {
    ...
    headlineLine1: "Portugal doesn't need to prove it knows how to work the sea.",
    headlineLine2: 'It needs to scale what it already does well.',
    subheadline:
